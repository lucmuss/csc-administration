...
CLUB_SUPPORT_EMAIL = _env_first("CLUB_SUPPORT_EMAIL", default=CLUB_CONTACT_EMAIL)
CLUB_CONTACT_PHONE = _env_first("CLUB_CONTACT_PHONE", default="")
CLUB_TELEGRAM_URL = _env_first("CLUB_TELEGRAM_URL", default="")
CLUB_WHATSAPP_URL = _env_first("CLUB_WHATSAPP_URL", default="")
