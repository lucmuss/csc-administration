# Content, Legal & Semantik-Audit – v2
...
□ Ist die Adresse per Google Maps verifizierbar?
...
| Pflicht zur Bereitstellung (vertraglich/gesetzlich) | | | |
...
□ Wo kann man Cookie-Einstellungen nachträglich ändern?

1.4 ALLGEMEINE GESCHÄFTSBEDINGUNGEN (AGB)

□ Existieren AGB / Nutzungsbedingungen?
□ Sind sie vor Vertragsschluss/Registrierung einsehbar?
□ Muss der Nutzer aktiv zustimmen (Checkbox)?
□ Ist die Checkbox NICHT vorausgewählt?
□ Sind die AGB verständlich formuliert?
...
2.1 SPRACHUMSCHALTER (i18n)

□ Existiert ein Sprachumschalter?
□ Position: Wo befindet er sich? Gut auffindbar?
□ Darstellung: Flaggen, Text, Dropdown?

Für JEDE verfügbare Sprache testen:
| Sprache | Umschaltung funktioniert? | Vollständig übersetzt? | Fehler |
|---------|--------------------------|----------------------|--------|
| Deutsch | | | |
| Englisch | | | |
| [Weitere] | | | |

Detailprüfung nach Sprachwechsel:
□ Werden ALLE UI-Elemente übersetzt?
□ Bleiben Teile auf Deutsch/Originalsprache?
□ Werden Datumsformate angepasst (DD.MM.YYYY vs. MM/DD/YYYY)?
□ Werden Zahlenformate angepasst (1.000,00 vs. 1,000.00)?
□ Werden Einheiten angepasst (falls relevant)?
□ Bleibt die gewählte Sprache nach Seitenwechsel?
□ Bleibt die gewählte Sprache nach erneutem Login?
□ Ist die URL lokalisiert (/de/, /en/) oder Parameter (?lang=)?

Übersetzungsfehler dokumentieren:
| Seite | Element | Originaltext | Übersetzung | Problem |
|-------|---------|--------------|-------------|---------|
| | | | | Nicht übersetzt |
| | | | | Falsch übersetzt |
| | | | | Abgeschnitten |
...
2.4 PLATZHALTER & DUMMY-INHALTE

□ Gibt es noch Lorem-Ipsum-Texte?
□ Gibt es noch "[Platzhalter]" oder "TODO"-Texte?
□ Gibt es noch Beispiel-Daten die als echt erscheinen?
□ Gibt es leere Seiten oder Sektionen?
...
|-----|--------------|---------------------|---------|------------|
| /dashboard | Übersicht | ✅ | | |
| /usr/mgmt | Benutzerverwaltung | ❌ | Kryptisch | /benutzer oder /users |
| /pg1 | Seite 1 | ❌ | Bedeutungslos | /[seiteninhalt] |
...
□ Stimmt die URL mit dem Seiteninhalt überein?
□ Stimmt die URL mit der Navigation überein?

3.2 NAVIGATION-URL-KONSISTENZ

□ Entspricht die URL dem Menüpunkt-Namen?
  - Menü: "Mitgliederverwaltung" → URL: /mitglieder ✅
  - Menü: "Mitgliederverwaltung" → URL: /mbr-mgmt ❌

□ Entspricht die URL dem Seitentitel?
□ Entspricht die URL den Breadcrumbs?

3.3 TECHNISCHE URL-PROBLEME

□ Gibt es doppelte Slashes (//)?
□ Gibt es trailing Slashes inkonsistent (/seite vs. /seite/)?
□ Gibt es case-sensitivity Probleme (/Seite vs. /seite)?
...
□ Ist der Placeholder-Text hilfreich (nicht identisch mit Label)?

4.2 MEHRDEUTIGE BEZEICHNUNGEN

Identifiziere Felder die Verwirrung stiften könnten:
...
| "Nr." | | Was für eine? | Mitgliedsnr? Auftragsnr? | |

4.3 TECHNISCHE FELDNAMEN IM UI

□ Werden Datenbank-Feldnamen angezeigt?
  - Schlecht: "created_at", "usr_id", "qty"
  - Gut: "Erstellt am", "Benutzer-ID", "Menge"

□ Werden technische Fehlermeldungen angezeigt?
  - Schlecht: "UNIQUE constraint failed"
  - Gut: "Diese E-Mail-Adresse ist bereits registriert"
...
Für ALLE angezeigten Zahlenwerte:

□ Einheiten:
  - Ist die Einheit angegeben (g, kg, €, Stück)?
  - Ist die Einheit korrekt?
  - Ist die Einheit konsistent über die Anwendung?

□ Formatierung:
  - Tausendertrennzeichen korrekt (1.000 nicht 1000)?
  - Dezimaltrennzeichen korrekt (1,5 nicht 1.5 für DE)?
  - Anzahl Dezimalstellen sinnvoll und konsistent?
  - Währungssymbol korrekt positioniert (€ hinten in DE)?

□ Plausibilität:
  - Sind negative Werte möglich wo sie nicht sein sollten?
  - Sind unrealistisch hohe Werte möglich?
  - Werden Nullwerte korrekt dargestellt (0 oder "-" oder leer)?

5.2 BERECHNUNGEN VERIFIZIEREN

Teste Berechnungen mit konkreten Werten:
...
□ Werden Limits korrekt berechnet (Monatsabgabe)?
□ Werden Rundungen korrekt durchgeführt?
□ Gibt es Rundungsfehler bei Kommawerten?

5.3 ÜBERSICHTEN & DASHBOARDS

□ Sind Summen/Totals korrekt?
□ Sind Prozentangaben korrekt (addieren sich zu 100%)?
□ Stimmen Detailansicht und Übersicht überein?
□ Werden Filter korrekt auf Berechnungen angewendet?

5.4 DATUMS- UND ZEITWERTE

□ Ist das Datumsformat konsistent (TT.MM.JJJJ)?
□ Werden Uhrzeiten im 24h-Format angezeigt?
□ Ist die Zeitzone korrekt (Europe/Berlin)?
□ Werden relative Zeiten korrekt berechnet ("vor 2 Tagen")?
□ Werden Fristen korrekt berechnet?

5.5 CANNABIS-LIMITS GEM. CanG
...
□ Gibt es eine Kurzbeschreibung wo nötig?

6.2 NAVIGATIONSBEGRIFFE

| Menüpunkt | Was Nutzer erwartet | Was sich dahinter verbirgt | Problem? |
|-----------|--------------------|-----------------------------|----------|
| | | | |
...
□ Sind Hilfetexte verständlich und aktuell?
...
Qualitätskriterien für Fehlermeldungen:
...
7.2 ERFOLGSMELDUNGEN

| Aktion | Erfolgsmeldung | Angemessen? |
|--------|----------------|-------------|
| Speichern | | |
| Löschen | | |
| Registrierung | | |
...
□ Gibt es überhaupt Erfolgsmeldungen?
□ Bestätigen sie konkret was passiert ist?
□ Sind sie nicht zu aufdringlich?

7.3 WARNMELDUNGEN

□ Wird vor destruktiven Aktionen gewarnt?
□ Ist klar was bei "Ja" passiert?
□ Ist die Warnung angemessen (nicht übertrieben)?
...
8.2 KONSUM-/ABGABE-ÜBERSICHT (Nutzerperspektive)
...
□ Sind alle relevanten Informationen auf einen Blick sichtbar?

| Information | Wo zu finden? | Leicht auffindbar? | Klar dargestellt? |
|-------------|---------------|-------------------|-------------------|
| Aktueller Kontostand (falls relevant) | | | |
...
Als Admin:
□ Gibt es eine Übersicht aller Mitglieder?
□ Gibt es eine Übersicht aller Abgaben?
□ Gibt es Bestandsübersichten?
□ Sind Suchfunktionen vorhanden und funktional?
□ Können Daten gefiltert werden?
□ Können Daten exportiert werden?
□ Sind Statistiken/Reports vorhanden?
...
|---|---------|---------|--------|-----------------|----------------|
| 1 | | | Abmahnung/Bußgeld | § X TMG/DSGVO | |

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🌐 SPRACHUMSCHALTER-AUDIT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Unterstützte Sprachen: [Liste]
Standardsprache: [Sprache]

Übersetzungsprobleme:
| Seite | Element | Originaltext | Problem | Korrektur |
|-------|---------|--------------|---------|-----------|
...
8. Sprachumschalter-Tests nur durchführen wenn die Funktion tatsächlich in der App existiert – anderenfalls als "Nicht implementiert" dokumentieren
```
