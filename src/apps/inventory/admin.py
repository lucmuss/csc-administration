...
class StrainAdmin(admin.ModelAdmin):
    list_display = ("image_preview", "name", "product_type", "card_tone", "quality_grade", "thc", "cbd", "price", "stock", "is_active")
    list_editable = ("product_type", "card_tone", "price", "stock", "is_active")
    search_fields = ("name",)
    list_filter = ("product_type", "card_tone", "quality_grade", "is_active")
    readonly_fields = ("image_preview",)
    fields = ("name", "product_type", "card_tone", "image", "image_preview", "thc", "cbd", "price", "stock", "quality_grade", "is_active")
