...
def test_social_club_admin_can_upload_profile_banner_and_gallery_images(client, settings, tmp_path):
    ...
    response = client.post(
        ...
        data={
            ...
            "city": club.city,
            "minimum_age": str(club.minimum_age),
            "max_verified_members": str(club.max_verified_members),
            "admission_fee": str(club.admission_fee),
            "monthly_membership_fee": str(club.monthly_membership_fee),
